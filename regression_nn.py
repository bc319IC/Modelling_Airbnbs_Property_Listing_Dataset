...
def train_test(model, train_loader, val_loader, test_loader, folder, num_epochs=10, config=None, log_dir="runs/nn_training_regression"):
    """
...
if __name__ == "__main__":
    ...
    best_model, best_metrics, best_hyperparams = find_best_nn(train_loader, val_loader, test_loader, folder=f"models/neural_networks/regression/{label}", num_epochs=100)
